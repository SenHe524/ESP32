...
/*  ULL:unsigned long long  1ULL：表示将 1 的类型声明为unsigned long long
    (1ULL<<GPIO_OUTPUT_IO_0) | (1ULL<<GPIO_OUTPUT_IO_1)  意为：1循环左移GPIO_OUTPUT_IO_0（18）位
    或上 1循环左移GPIO_OUTPUT_IO_1（19）位
    也即：1 000 000 000 000 000 000  | 10 000 000 000 000 000 000 = 11 000 000 000 000 000 000
*/
...
void gpio_intr_init(void)
{
    ...
    gpio_isr_handler_remove(GPIO_INPUT_IO_0);//允许每个GPIO注册中断处理程序
