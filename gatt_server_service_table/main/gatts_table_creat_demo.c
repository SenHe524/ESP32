...
uint16_t flag_test1 = 0;
uint16_t flag_test2 = 0;
uint16_t flag_test3 = 0;
uint16_t flag_test4 = 0;
typedef struct {
    uint8_t                 *prepare_buf;
    int                     prepare_len;
} prepare_type_env_t;
    ...
    switch (event) {
        ...
        case ESP_GATTS_READ_EVT:
            ...
            switch(param->write.handle){
                    case 42:
                        rsp.attr_value.value[0] = flag_test1;
                        break;
                    case 45:
                        rsp.attr_value.value[0] = flag_test2;
                        break;
                    case 47:
                        rsp.attr_value.value[0] = flag_test3;
                        break;
                    case 49:
                        rsp.attr_value.value[0] = flag_test4;
                        break;
                    default:
                        break;
                }
        ...
        case ESP_GATTS_WRITE_EVT:
            if (!param->write.is_prep){
                ...
                switch(param->write.handle){
                    case 42:
                        flag_test1 = *param->write.value;
                        break;
                    case 45:
                        flag_test2 = *param->write.value;
                        break;
                    case 47:
                        flag_test3 = *param->write.value;
                        break;
                    case 49:
                ...
                printf("%d\n%d\n%d\n%d\n",flag_test1,flag_test2,flag_test3,flag_test4);
...
void app_main(void)
{
    ...
    ESP_LOG_BUFFER_HEX(GATTS_TABLE_TAG,mac,6);
