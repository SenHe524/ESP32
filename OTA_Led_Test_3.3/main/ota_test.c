...
static void ota_example_task(void *pvParameter)
{
    ...
    //获取紧邻 当前使用的OTA_X分区 的下一个可用于烧录升级固件的Flash分区
    //若当前为OTA_0,则获取到的为OTA_1，若当前为OTA_1,则获取到的为OTA_0，
    ...
    //OTA data区数据升级完成，重启并获取OTA data区数据，以决定此后加载哪一个分区的固件执行
